<template>
  <div class="w-[1500px] mt-5 p-8  bg-white rounded shadow-2xl  mb-12">
    ...
    <form @submit.prevent="joinuser">
      ...
      <label for="role" class="inline mb-2 text-sm font-bold text-blue-900">2. 기본 정보 입력  <p class="inline text-red-500">*</p><p class="inline text-gray-300">표시는 필수 입력 표시입니다.</p></label>
      <hr class="m-1">

      <div class="mb-4 mt-10">
        <label for="name" class=" block py-2 text-sm font-bold text-gray-700"
          ><p class="inline text-red-500">* </p>이름
      ...
      <!-- <div class="mb-4">
        <label for="userid" class="block mb-2 text-sm font-bold text-gray-700"
          ><p class="inline text-red-500">* </p>아이디
          </label
        >
      ...
      <!-- <div class="mb-4">
        <label for="password" class="block mb-2 text-sm font-bold text-gray-700"
          ><p class="inline text-red-500">* </p>비밀번호
      ...
      <div class="mb-4">
        <label for="phoneNumber" class="block mb-2 text-sm font-bold text-gray-700"
          ><p class="inline text-red-500">* </p>전화번호
      ...
      <button
        @click="joinuser"
        class="mr-3 px-8 py-2 mt-4 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none focus:shadow-outline"
        type="button"
      >
        다음
      </button>
